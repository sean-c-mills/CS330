...
1. How do I approach designing software?
   ...
   my work through iterations, can be applied to my future projects to help keep the development more organized and efficient.

3. How do I approach developing programs?

     When developing programs, I focus on building the functionality in smaller steps and then testing it as I go. While working on my 3D scene,
   I used new development strategies like breaking my code into smaller functions for rendering objects, setting up lights, and handling the camera
   controls. This made my program easier to read and easier to update as the project grew in size. Iteration also played a big role throughout the
   milestones, since each module added new features like movement, textures, and lighting. Instead of trying to build everything at once, I improved
   the scene gradually over time and made adjustments based on how the scene looked and behaved. Over time, my approach to writing code became more
   organized and structured, which helped lead to a smoother final project and less issues when I combined everything together.
